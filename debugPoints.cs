...
namespace NITEProvider
{
    public partial class debugPoints : Form
    {
        public debugPoints()
        {
			...
			Bitmap defaultImage = new Bitmap(20, 20);
        ...
        public void set_actionimage(Brush br)
        {
            lock (this)
            {
                Bitmap defaultImage = new Bitmap(20, 20);
                ...
                Graphics g = Graphics.FromImage(defaultImage);
                g.FillEllipse(br, 0, 0, 20, 20);

                ActionImage = defaultImage;
                UpdateLayered();
                Show();
                //Console.WriteLine("Color 332423..");
            }
        }
        private void debugPoints_Load(object sender, EventArgs e)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "debugPoints";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.debugPoints_Load);
